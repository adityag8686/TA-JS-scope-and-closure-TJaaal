...
counter.increment(); // output  undefined but privateCounter value changes to 1
counter.increment(); // output undefined but privateCounter value changes to 2
counter.value(); // output 2
counter.decrement(); // output undefined but privateCounter value changes to 1
